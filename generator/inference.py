...
def parse_config():
    ...
    # model configuration
    parser.add_argument('--model_name', type=str, default='../中文预训练模型/bart-base-chinese')
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        ...
        print('Overall bleu is %5f, Overlap bleu is %5f, Nonoverlap bleu is %5f' % (
        overall_bleu, overlap_bleu, nonoverlap_bleu))
